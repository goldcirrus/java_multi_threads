/*matrix product with multiple threads*/
...
public class MatrixProduct {
    ...
    public static void main(String[] args) {
       ...
       /*fill the first matrix with random double numbers. */
        ...
        System.out.println("Enter the column number for the second matrix:\n (its row number must be equal to the first matrix's column number:"+q+")");
        n = scan2.nextInt();
        ...
        for(int i=0; i<q; i++) {
            for(int j=0; j<n; j++) {
                second[i][j]=rand1.nextDouble()*20;
            }
        }
        ...
        /*declare and initialize a result matrix which is empty but with right size.*/        
        ...
        System.out.println("The product matrix of the first and the second matrix is below:");
